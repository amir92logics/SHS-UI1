...
class index extends Component {
    constructor(props) {
      ...
      componentWillMount(){
          ...
          if (json.success) {
            ...
            let result = json.result.map(function (key) {
              ...
              return (
                ...
                <div  key= {key.id} className="card " style={{width:'250px', height:'157px',boxShadow: '8px 8px 5px grey'}}>
                  ...
                  <div className="card-body"      style={{height: '155px',top:'-25px',marginTop: '-18px'}}>
                    ...
                    {/* JSON Web Token (JWT) is an open standard (RFC 7519) that defines a compact and self-contained way for ... */}
                      ...
                      {key.description?
                       key.description.slice(0, 100) + (key.description.length > 50 ? "..." : ""):
                       null
                      }
                    ...
                    {/* Button */}
                    <Link to="/bidding" className="btn btn-primary btn-sm" style={{borderRadius:'30px',position: 'absolute', bottom: '27px' ,fontSize:'9px'}}>More Info</Link>
                 
                    <a href="/" className="btn btn-primary btn-sm" style={{borderRadius:'30px',position: 'absolute', bottom: '27px', right: '18px' ,fontSize:'9px'}}>See Bids</a>
                  </div>
        ...
        return (
            <div >
                <div style={{float:'right', position: 'absolute', top: '65px',right:'30px'}}>
                    <Link to='/myproject'>
                      
                <button className='btn btn-primary add-project btn-sm' style={{borderRadius:'20px', width:'73px',fontSize: '8px'}}>ADD NEW  <i className="fal fa fa-long-arrow-right"></i></button>
                </Link>
                </div>
                <section  className=''>
           ...
           <div className="container body-container mt-5 d-flex justify-content-center">
             ...
             <div className=" row col-md-12 " style={{marginBottom: '19px',    marginTop: '-27px'}}>
           {renderitems}
             </div>
           </div>
         </section>
